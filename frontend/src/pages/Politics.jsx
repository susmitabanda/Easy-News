...
function Politics() {
  ...
  useEffect(() => {
    axios.get('https://newsapi.org/v2/top-headlines?sources=bbc-news,cnn&apiKey=9f25eef6dd5240368ea6b7fb9d392a63')
      .then(response => {
  ...
  const handleSummarize = async (title, description, idx) => {
    ...
    if (loading) return <div className='loadingnews'><h1>Loading politics news...</h1></div>;
