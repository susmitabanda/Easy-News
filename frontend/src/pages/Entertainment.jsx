...
//   const [summary, showSummary] = useState({});  // Store summaries for each article by index

//   useEffect(() => {
//     axios.get('https://newsapi.org/v2/top-headlines?category=entertainment&apiKey=9f25eef6dd5240368ea6b7fb9d392a63')
//       .then(response => {
...
//   if (loading) return <div className='loadingnews'><h1>Loading Entertainment news...</h1></div>;
